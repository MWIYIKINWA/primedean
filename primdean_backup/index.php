    ...
    <div class="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20 w-full mt-5 lg:mt-5">
            ...
            <div class="swiper heroSwiper w-full h-[350px] md:h-[450px] lg:h-[550px] rounded-3xl relative z-10 overflow-hidden border border-white/50 group"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="assets/images/4.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/images/new1.jpg" class="w-full h-full object-cover" alt="Custom Signage">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/images/new2.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/images/new3.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    ...
                    <!-- Slide 2: Printing -->
                    <div class="swiper-slide">
                        <img src="assets/images/new/9.jpg" class="w-full h-full object-cover"
                            alt="High Quality Printing">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <!-- Slide 3: Vehicle Branding -->
                    <div class="swiper-slide">
                        <img src="assets/images/new/8.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <!-- Slide 3: Vehicle Branding------------------------------------------------- -->
                    ...
                    <!-- Slide 2: Printing -->
                    <div class="swiper-slide">
                        <img src="assets/images/h2.jpg" class="w-full h-full object-cover" alt="High Quality Printing">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <!-- Slide 3: Vehicle Branding -->
                    <div class="swiper-slide">
                        <img src="assets/images/h1.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <!-- Slide 3: Vehicle Branding------------------------------------------------- -->
                    <div class="swiper-slide">
                        <img src="assets/images/27a.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <!-- Slide 3: Vehicle Branding -->
                    <div class="swiper-slide">
                        <img src="assets/images/new/6.jpg" class="w-full h-full object-cover" alt="Vehicle Branding">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <!-- Slide 3: Vehicle Branding------------------------------------------------- -->
                </div>
        ...
        <div class="w-full lg:hidden lg:w-1/2 relative max-md:px-4">
            ...
            <div class="swiper heroSwiper w-full h-[350px] md:h-[450px] lg:h-[550px] rounded-3xl relative z-10 overflow-hidden border border-white/50 group"
                style="--swiper-pagination-color: #E0C1D7; --swiper-pagination-bullet-inactive-color: #ffffff; --swiper-pagination-bullet-inactive-opacity: 0.5; --swiper-navigation-color: #ffffff; --swiper-navigation-size: 20px;">
                <div class="swiper-wrapper">
                    <!-- Slide 1: Signage/Branding -->
                    <div class="swiper-slide">
                        <img src="assets/images/4.jpg" class="w-full h-full object-cover" alt="Custom Signage">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/images/new1.jpg" class="w-full h-full object-cover" alt="Custom Signage">
                    ...
                    <div class="swiper-slide">
                        <img src="assets/images/new/1.jpg" class="w-full h-full object-cover" alt="Custom Signage">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    </div>
...
<!-- Featured Work -->
<section id="portfolio" class="py-10 px-6 md:px-10 lg:px-15 xl:px-18 bg-slate-50">
    <!-- Masonry/Grid Gallery -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">

        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative  overflow-hidden h-full cursor-pointer bg-[#812C84]">
            <img src="assets/images/pullups.jpg"
                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-90" alt="Work 1">
        </div>

        <!-- Item 2 -->
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#E0C1D7]">
            <img src="assets/images/8.jpg"
                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-90" alt="Work 2">
        </div>
        ...
        <div onclick="openModal(this.querySelector('img').src)"
            ...
            <img src="assets/images/16.jpg"
                class="w-full h-full object-fit transition-transform duration-500 group-hover:scale-90" alt="Work 3">
        </div>
        <!-- Item 1 -->
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#E0C1D7]">
            <img src="assets/images/danger.jpg"
                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-90" alt="Work 1">
        </div>
        <!-- Item 2 -->
        <div onclick="openModal(this.querySelector('img').src)"
        ...
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#E0C1D7]">
            <img src="assets/images/58.jpg"
                class="w-full h-full object-fit transition-transform duration-500 group-hover:scale-90" alt="Work 3">
        </div>
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative  overflow-hidden h-full cursor-pointer bg-[#812C84]">
            <img src="assets/images/temp.jpg"
                class="w-full h-full object-fit transition-transform duration-500 group-hover:scale-90" alt="Work 1">
        </div>

        <!-- Item 2 -->
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#E0C1D7]">
            <img src="assets/images/poster5.jpg"
                class="w-full h-full object-fit  transition-transform duration-500 group-hover:scale-90" alt="Work 2">
        </div>

        <!-- Item 3 -->
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#812C84]">
            <img src="assets/images/vaito.jpg"
                class="w-full h-full object-fit transition-transform duration-500 group-hover:scale-90" alt="Work 3">
        </div>
        <!-- Item 1 -->
        <div onclick="openModal(this.querySelector('img').src)"
        ...
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#812C84]">
            <img src="assets/images/neww.jpg"
                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-90" alt="Work 1">
        </div>
        <!-- Item 2 -->
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#E0C1D7]">
            <img src="assets/images/new26.jpg"
                class="w-full h-full object-fit transition-transform duration-500 group-hover:scale-90" alt="Work 2">
        </div>
        <!-- Item 3 -->
        <div onclick="openModal(this.querySelector('img').src)"
            class="group relative overflow-hidden h-full cursor-pointer bg-[#812C84]">
            <img src="assets/images/new24.jpeg"
                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-90" alt="Work 3">
        </div>
    </div>
</section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        <a href="service-detail.php?service=visibility-banners"
            ...
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/nsssf.jpg" alt="Custom Signage"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Visibility Banners</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Let your brand stand out with
                    professionally designed and produced teardrop banners, pull-up banners, X-stand, backdrop banners
                    and vinyl banners. From corporate events and exhibitions to activations, offices and outdoor
                    promotions, Primedean Limited delivers practical visibility solutions that keep your brand seen,
        ...
        <a href="service-detail.php?service=printing-services"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/new/4.jpg" alt="Promotional Items"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Printing Services</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Bring your ideas to print with
                    quality and professional finishing. From reports, books, manuals and workbooks to flyers, brochures,
                    posters, table talkers, business cards, calendars, notebooks, folders and other corporate
                    stationery, Primedean delivers reliable printing solutions tailored to your brand and requirements.
                </p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
        ...
        <a href="service-detail.php?service=promotional-items"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/ss4.jpg" alt="Offset & Digital Printing"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Visibility Promotional Items</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Keep your brand visible beyond
                    the first interaction with customised promotional items designed for everyday use. From branded
                    T-shirts, umbrellas, bottles and mugs to thermal flasks, tote bags, caps, notebooks, keyholders and
                    corporate gifts, Primedean delivers quality merchandise that keeps your brand in the hands and minds
                    of your customers.</p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
        ...
        <a href="service-detail.php?service=events-branding"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/4.jpg" alt="Promotional Items"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Events Branding</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Make your event look
                    professional and your brand impossible to miss. From backdrops, banners and exhibition stands to
                    photo booths, speaker podiums, stage branding and event signage, Primedean delivers complete event
                    branding solutions designed to create a consistent and memorable brand experience.</p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
                </span>
        ...
        <a href="service-detail.php?service=office-branding"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/jubilee.jpg" alt="Promotional Items"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Office Branding</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Turn your office into a
                    professional expression of your brand. Primedean provides brand-colour painting, wall graphics, door
                    and window branding, vinyl wraps, frosted and one-way vision stickers, reception branding and office
                    signage, professionally designed, printed and installed to create a consistent brand environment.
                </p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
        ...
        <a href="service-detail.php?service=outdoor-banners"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/mtn.jpg" alt="Promotional Items"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Outdoor Banners</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Take your message to where your
                    audience is. From street and roadside advertising to golf clubs, malls, billboards, events, sports
                    venues, buildings and perimeter branding, Primedean produces durable, highimpact outdoor banners
                    designed for maximum visibility in public spaces and changing weather conditions.</p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
                </span>
        ...
        <a href="service-detail.php?service=signage-solutions"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/global.webp" alt="Vehicle Branding"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Signage Services</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Get your business noticed with
                    professionally designed, produced and installed signage built for lasting visibility. From custom,
                    reception and indoor glass signage to roadside signs, pylons, lightboxes, directional and safety
                    signage, as well as 2D and 3D solutions, Primedean delivers durable signage designed to maintain a
                    professional brand presence even under harsh outdoor weather conditions.</p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
                </span>
        ...
        <a href="service-detail.php?service=vehicle-branding"
            ...
            <!-- Image Top -->
            <div class="w-full h-48 relative overflow-hidden">
                <img src="assets/images/wraps.jpg" alt="Promotional Items"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <!-- Content -->
            <div class="p-6 flex flex-col grow">
                <h3 class="text-xl font-bold mb-3">Vehicle & Motorcycle Branding</h3>
                <p class="text-white/80 text-sm leading-relaxed mb-6 grow text-justify">Take your brand wherever your
                    business goes. Primedean professionally brands motorcycles, company cars, pickups, vans, trucks,
                    trailers and entire fleets using quality, durable materials designed to maintain strong visibility
                    through everyday road use, dust and changing weather conditions.</p>
                <span
                    class="text-[#E0C1D7] group-hover:text-white font-medium text-sm transition-colors flex items-center gap-2 mt-auto">
                    Explore <i class="fa-solid fa-arrow-right text-xs"></i>
                </span>
...
<section class="py-12 md:py-16 bg-slate-50 border-y border-slate-200/80">
    <div class="max-w-7xl mx-auto px-6 md:px-16 lg:px-24">
        ...
        <div class="text-center max-w-xl mx-auto mb-10">
            ...
            <h2 class="text-lg md:text-xl font-extrabold text-[#812C84] mt-3">
...
<section id="about" class="relative py-20 px-6 md:px-8 lg:px-24 xl:px-12 bg-[#812C84] overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div class="w-full h-full lg:w-1/2 relative">
            ...
            <img src="assets/images/about.jpeg" alt="Primedean Team"
