...
// Define the styles for active vs inactive links
$active_class = "text-[#E0C1D7]  font-bold border-b-2 border-[#E0C1D7] pb-1";
$inactive_class = "text-white hover:text-[#E0C1D7] transition-colors pb-1";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description"
        content="<?= $page_description ?? 'Primedean Limited – Branding, Signage & Printing in Kampala' ?>">

    <!-- Local SEO & Canonical -->
    <meta name="keywords"
        content="Branding in Kampala, Vehicle Wraps Uganda, Signage, Corporate Printing, Primedean Limited">
    ...
    <meta name="twitter:description"
        content="<?= $page_description ?? 'Primedean Limited – Building brand Awareness and Visibility' ?>">
    ...
    <script>
        document.documentElement.setAttribute('data-prefers-reduced-motion', window.matchMedia(
            '(prefers-reduced-motion: reduce)').matches ? 'true' : 'false');
    </script>
</head>
