<div class="text-sm text-white w-full">
    ...
    <!-- Top Contact Banner -->
    <div
        class="bg-[#E0CID7] text-[#812C84] text-xs py-2 px-4 md:px-16 lg:px-24 xl:px-32 flex flex-wrap items-center justify-center sm:justify-between gap-3 font-medium">
    ...
    <nav
        ...
        <button aria-label="menu-btn" type="button"
            class="menu-btn pr-3 inline-block md:hidden active:scale-90 transition">
        ...
        <div class="mobile-menu absolute top-[70px] left-0 w-full bg-[#812C84] shadow-sm p-6 hidden md:hidden z-50">
